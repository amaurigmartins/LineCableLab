function [Ti,g]=NR_calc_double_norm_str(ord,num_files,Z,Y,freq)
...
for k=1:1:num_files % Με αύξηση της συχνότητας!
    ...
    if k==1 % Στην πρώτη συχνότητα εφαρμόζεται QR decomposition! - Προσοχή!!! Χειροκίνητα μπορεί να εφαρμοστεί και στη δεύτερη συχνότητα κ.ο.κ.
        ...
        S=(S./norm)-O; % Κανονικοποίηση του γινομένου Y'Z' - (ord x ord) 
        ...
        ldis=(ldis./norm)-1; % Κανονικοποίηση των ιδιοτιμών
        ...
        ldis=(ldis+1).*norm; % Αντιστροφή της κανονικοποίησης - (1 x ord)
