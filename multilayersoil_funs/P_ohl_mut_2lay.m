function [Pg_mutual]=P_ohl_mut_2lay(h,d,e_g,m_g,sigma_g,t,f,con,kx)

if nargin==8
    kx=0; %sets default to zero
end

% Function for the 2-layered Mutual Earth Potential as per Sunde's formula
        ...
        if x~=y
            ...
            if (h1 > 0 && h2 > 0)
                ...
                yfun=@(lambda,omega) sum([0 ...
                    yy(a_1(lambda,omega),...
                    gg1(a_1(lambda,omega),a_2(lambda,omega),a_3(lambda,omega),gamma_1(omega),h1,m_g(1),m_g(2),m_g(3),omega,t),...
                    gamma_1(omega),...
                    h1,...
                    h2,...
                    lambda,...
                    m_g(1),...
                    omega,...
                    qq1(a_1(lambda,omega),a_2(lambda,omega),a_3(lambda,omega),gamma_1(omega),gamma_2(omega),gamma_3(omega),h1,m_g(1),m_g(2),m_g(3),omega,t),...
                    d(x,y))...
                    ],'omitnan');
