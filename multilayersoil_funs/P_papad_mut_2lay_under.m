function [Pg_mutual]=P_papad_mut_2lay_under(h,d,e_g,m_g,sigma_g,t,f,con,kx)
...
% t       : layer thickness [m]
% Output
% Pg_mutual : Mutual earth potential of the underground conductor [Ohm/m]
...
for x=1:1:con
    for y=1:1:con
        if x~=y
            ...
            Pg_mutual(x,y)=(1i*w/(2*pi*(sigma_1+1i*w*e_1)))*Qm;
