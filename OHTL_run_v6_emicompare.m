...
soil_eps=3; %this is not used if FD_flag != 0
% These are whatever formulas I choose to compute modal params
Zmod_src='Ztot_Carson';%Zmod_src='Ztot_Pettersson';
Ymod_src='Ytot_Imag';%Ymod_src='Ytot_Pettersson';
% Flags
...
decmp_flag = 9; % Modal decomposition flag. (1) QR,(2)QR ATP,(3)simple_QR,(4)simple_QR,(5)NR,(6)NR_back,(7)SQP,(8)SQP_back,(9)LM,(10)LM_back,(11)LM_fast,(12)LM_alt, (13) eigenvalue shuffle QR, (14) intercheig QR

% jobid will be appended to whatever file or plot generated by this run
jobdesc = 'cmpmet_';
jobid = [jobdesc 'FD' num2str(FD_flag) '_' Zmod_src '_' Ymod_src '_rho' num2str(fix(soil_rho)) '_eps' num2str(soil_eps)];
...
Geom = [1  -6.6     13.5   0.00463  0.01257  7.1221e-8   1     nan    nan   nan   1
    ...
    4  -4.65    17.6   0.00000  0.004765 2.46925E-7   1     nan    nan   nan  1
    5   4.65    17.6   0.00000  0.004765 2.46925E-7   1     nan    nan   nan   1
    6   10.0    -1.0   0.12450  0.12700  2.8444e-7   250   0.227    1     3   1; 
    ];     % P66
