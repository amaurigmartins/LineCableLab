function [length,Ncon,r,rad_ex,rad_in,erg,mrg,sigma_g,sigma_w,e0,m0,m_g,h,d]=set_line_data()
% Line Geometry
%
...
Geom = [1   0     8   0.00318  2.826e-8   10   1
        2   1.5   8   0.00318  2.826e-8   10   1
        3   2.3   8   0.00318  2.826e-8   10   1];
...
sigma_g=1/100; %conductivity of earth
sigma_w=1/3.86063e-008; %conductivity of conductor
% delta=rad_ex-rad_in;
% Rdc=((1/sigma_w)/(pi*delta*((2*r)-delta))) * 1000
