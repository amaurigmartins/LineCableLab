function [Ti,g]=LM_calc_norm_back(ord,num_files,Z,Y,freq)
...
%     k % Δείκτης για να ενημερώνει στο command window σε ποια συχνότητα βρισκόμαστε
    ...
    if k==num_files || k==2 || k==1 % Στην πρώτη και τελευταία συχνότητα εφαρμόζεται QR decomposition! Στην πρώτη διότι έτσι ξεκινά ο αλγόριθμος και στην τελευταία δίοτι είναι τα 0 Hz και δεν μπορεί να κανονικοποιηθεί με νόρμα το υπό εξέταση γινόμενο - Προσοχή!!! Χειροκίνητα μπορεί να εφαρμοστεί και στη δεύτερη συχνότητα κ.ο.κ.
        ...
        for o=1:ord
            ...
            options=optimset('Algorithm',{'levenberg-marquardt',0.0001},'Display','off','ScaleProblem','Jacobian'); % Διάφοροι παράμετροι για την επίλυση του προβλήματος της συνάρτησης-αντικειμένου
