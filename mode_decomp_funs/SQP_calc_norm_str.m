...
for k=1:1:num_files % Με αύξηση της συχνότητας!
    ...
    if k==1 || k==2 % Στην πρώτη συχνότητα εφαρμόζεται QR decomposition! - Προσοχή!!! Χειροκίνητα μπορεί να εφαρμοστεί και στη δεύτερη συχνότητα κ.ο.κ.
        ...
        for o=1:ord
            ...
            %options=optimset('Algorithm','sqp','Display','off','FinDiffType','central','TolFun',0,'MaxFunEvals',6000); % Διάφοροι παράμετροι για την επίλυση του προβλήματος της ελαχιστοποίησης της συνάρτησης-αντικειμένου
