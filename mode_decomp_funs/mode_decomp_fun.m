function [Zch_mod,Ych_mod,Zch,Ych,g,a,vel,Ti,Z,Y] = mode_decomp_fun(Z_full,Y_full,freq,freq_siz,ord,decmp_flag,sigma_g_total,erg_total,ZYprnt,tag)
...
if decmp_flag == 1
    ...
    if (ZYprnt)
        plotwavchar_fun(freq,ord,a,vel,Zch_mod,Ti,sigma_g_total,erg_total,tag)
    end
elseif decmp_flag == 2
