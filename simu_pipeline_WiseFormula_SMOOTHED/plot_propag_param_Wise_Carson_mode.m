...
%% Wise x Carson for a specific mode

set_plot_params([1 2 2 1 1 4 1])
figure('Name',['WiseCarson___rho___CP_mode' num2str(mode)])
subplot(1,2,1)
...
title(['mode # ' num2str(mode) ' - Attenuation constant, Constant soil parameters'])
axis tight
xlabel('Frequency [Hz]')
...
title(['mode # ' num2str(mode) ' - Phase velocity, Constant soil parameters'])
axis tight
xlabel('Frequency [Hz]')
...
set_plot_params([1 2 2 1 1 4 1])
figure('Name',['WiseCarson___rho___LS_mode' num2str(mode)])
subplot(1,2,1)
...
set_plot_params([1 2 2 1 1 4 1])
figure('Name',['WiseCarson___rho___Cigre_mode' num2str(mode)])
subplot(1,2,1)
...
set_plot_params([1 2 2 1 1 4 1])
figure('Name',['WiseCarson___FDmodel___rho100_mode' num2str(mode)])
subplot(1,2,1)

a_ref=read_from_file(const_model_dataset{1},'a_dis');
a=read_from_file(const_model_dataset{4},'a_dis');
yya = a ./ a_ref;
semilogx(f,yya(:,mode),'DisplayName', 'Constant soil parameters');hold all
...
vel=read_from_file(const_model_dataset{4},'vel_dis');
yyv = vel ./ vel_ref;
semilogx(f,yyv(:,mode),'DisplayName', 'Constant soil parameters');hold all
...
set_plot_params([1 2 2 1 1 4 1])
figure('Name',['WiseCarson___FDmodel___rho1000_mode' num2str(mode)])
subplot(1,2,1)
...
set_plot_params([1 2 2 1 1 4 1])
figure('Name',['WiseCarson___FDmodel___rho10000_mode' num2str(mode)])
subplot(1,2,1)
