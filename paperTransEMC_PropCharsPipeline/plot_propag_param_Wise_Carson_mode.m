...
set_plot_params()
figname=['WiseCarson___rho___CP_mode' num2str(mode)]
figure('Name',figname)
subplot(2,1,1)
...
title(['Normalized attenuation constant - mode #' num2str(mode) ' (a)'])
axis tight
xlabel('Frequency [Hz]')
...
title(['Normalized phase velocity - mode #' num2str(mode) ' (b)'])
axis tight
xlabel('Frequency [Hz]')
