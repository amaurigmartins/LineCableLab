function [Ytot_Imag,Ytot_Pet] = Y_clc_fun(f_total,ord,ZYprnt,FD_flag,siz,soil,h,d,Geom)
% Variables
...
if (ZYprnt)
    plotY_fun_ct(f_total,ord,Ytot_Imag,Ytot_Pet)
end

save Y_param.mat Ytot_Pet Ytot_Imag f