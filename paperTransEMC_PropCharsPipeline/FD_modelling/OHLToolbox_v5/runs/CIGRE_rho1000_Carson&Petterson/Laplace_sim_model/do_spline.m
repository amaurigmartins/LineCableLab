function [gamma,Z,Y,Ti,Ys,Yr]=do_spline(ord,freq,f,gamma_dis,Z_dis,Y_dis,Ti_dis,Ys_dis,Yr_dis)
...
for o=1:1:ord
    gamma_real(:,o)=spline(freq,real(gamma_dis(:,o)));
    gamma_imag(:,o)=spline(freq,imag(gamma_dis(:,o)));
    
    Ys_real(:,o)=spline(freq,real(Ys_dis(:,o)));
    Ys_imag(:,o)=spline(freq,imag(Ys_dis(:,o)));
    
    Yr_real(:,o)=spline(freq,real(Yr_dis(:,o)));
    Yr_imag(:,o)=spline(freq,imag(Yr_dis(:,o)));
end

for o=1:1:ord^2
    Z_real(:,o)=spline(freq,real(Z_dis(:,o)));
    Z_imag(:,o)=spline(freq,imag(Z_dis(:,o)));
    
    Y_real(:,o)=spline(freq,real(Y_dis(:,o)));
    Y_imag(:,o)=spline(freq,imag(Y_dis(:,o)));
    
    Ti_real(:,o)=spline(freq,real(Ti_dis(:,o)));
    Ti_imag(:,o)=spline(freq,imag(Ti_dis(:,o)));
end
