function [Ztot_Carson,Ztot_Noda,Ztot_Deri,Ztot_AlDe,Ztot_Sunde,Ztot_Pettersson,Ztot_Semlyen] = Z_clc_fun(f_total,ord,ZYprnt,FD_flag,siz,soil,h,d,Geom)
%% Variables
...
%% Plot parameters
if (ZYprnt)
    plotZ_fun_ct(f_total,ord,Ztot_Carson,Ztot_Noda,Ztot_Deri,Ztot_AlDe,Ztot_Sunde,Ztot_Pettersson,Ztot_Semlyen);
end

save Z_param.mat Ztot_Carson Ztot_Noda Ztot_Deri Ztot_Deri Ztot_AlDe Ztot_Sunde Ztot_Pettersson Ztot_Semlyen