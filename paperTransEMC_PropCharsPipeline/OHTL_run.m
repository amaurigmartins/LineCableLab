...
%% Calculations
tic
[Ztot_Carson,Ztot_Noda,Ztot_Deri,Ztot_AlDe,Ztot_Sunde,Ztot_Pettersson,Ztot_Semlyen, Ztot_Wise] = Z_clc_fun(f,ord,ZYprnt,FD_flag,freq_siz,soil,h,d,Geom); % Calculate Z pul parameters by different earth approaches
...
[Zch_mod,Ych_mod,Zch,Ych,g_dis,Ti_dis,Z_dis,Y_dis] = mode_decomp_fun(Ztot_Carson,Ytot_Imag,f,freq_siz,ord,decmp_flag,sigma_g_total,e_g_total,ZYprnt,jobid); % Modal decomposition
%[H_mod,F_mod,pol_co] = HF_VF_fun(Ti_dis,g_dis,line_length,f,ord); % Vector Fitting
toc

%% Save files
%save ZY_LM_CP_BB_1000.mat Ztot_Sunde Ytot_Imag g_dis Zch_mod Z_dis Y_dis
